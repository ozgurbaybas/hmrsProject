...
public class VJIKPSPublicSoap
{
    ...
    public VJIKPSPublicSoap(){}

    public VJIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VJIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VJIExtendedSoapSerializationEnvelope envelope= new VJIExtendedSoapSerializationEnvelope(VJIExtendedSoapSerializationEnvelope.VER11);
