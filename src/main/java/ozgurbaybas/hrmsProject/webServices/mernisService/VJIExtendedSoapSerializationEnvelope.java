...
public class VJIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VJIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VJIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VJIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VJIDateTimeConverter dateTimeConverter = new VJIStandardDateTimeConverter();

    public VJIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VJIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VJIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VJIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VJIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VJIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
